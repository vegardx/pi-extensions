...
simplification (simplification). Focus on your lane only; do not flag
issues that clearly belong to another lens.
...
Note: the generic lens handles known CVEs in third-party packages and
