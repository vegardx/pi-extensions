...
import { doPush, type PushTarget, resolvePushTarget } from "./push.js";
...
// Re-export prompt builders for backward compatibility (tests import from core.ts).
export { buildExecutePrompt, buildPlanPrompt } from "./prompts.js";
...
export async function runCommit(
	...
	const pushed = await doPush(ctx, pushTarget, nonInteractive, notify);
